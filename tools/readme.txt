...
Example-7 : Display current modified code files : Now time = 2017-09-12 15:55:52.312769 CST - China Standard Time
    for /f %a in ('lzmw -l -f "\.(cs|java|cpp|cx*|hp*|py|scala)$" -rp "%CD%" --nd "^(debug|release)$"  --w1 "2017-09-12 15:55:52" -PAC 2^>nul ') do @echo code file : %a
